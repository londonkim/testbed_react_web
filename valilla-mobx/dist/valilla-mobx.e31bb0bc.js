...
},{"process":"../../../.config/yarn/global/node_modules/process/browser.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var calculator = (0, _mobx.observable)({
  a: 1,
  b: 2
}); // 특정 값이 바뀔 때 특정 작업하기
...
(0, _mobx.reaction)(function () {
  return calculator.a;
}, function (value, reaction) {
  console.log("a\uAC12\uC774 ".concat(value, " \uB85C \uBC14\uB00C\uC5C8\uB124\uC694!"));
});
(0, _mobx.reaction)(function () {
  return calculator.b;
}, function (value) {
  console.log("b\uAC12\uC774 ".concat(value, " \uB85C \uBC14\uB00C\uC5C8\uB124\uC694!"));
});
calculator.a = 10;
calculator.b = 20; // computed로 특정 값 캐싱

var sum = (0, _mobx.computed)(function () {
  console.log('계산중이예요!');
  return calculator.a + calculator.b;
});
sum.observe(function () {
  return calculator.a;
});
sum.observe(function () {
  return calculator.b;
...
calculator.a = 20;
calculator.b = 30; // 여러번 조회 해도 캐싱된 값이 불러온다.

console.log(sum.value);
console.log(sum.value); // 여러번 조회 해도 캐싱된 값이 불러온다.

console.log(sum.value);
console.log(sum.value); // 내부의 값이 바뀌면 다시 호출 함

calculator.a = 20;
console.log(sum.value); // computed로 특정 값 캐싱

var minus = (0, _mobx.computed)(function () {
...
(0, _mobx.autorun)(function () {
  return console.log("@@@ a \uAC12\uC774 ".concat(calculator.a, " \uB85C \uBC14\uB00C\uC5C8\uB124\uC694!"));
});
(0, _mobx.autorun)(function () {
  return console.log("@@@ b \uAC12\uC774 ".concat(calculator.b, " \uB85C \uBC14\uB00C\uC5C8\uB124\uC694!"));
});
(0, _mobx.autorun)(function () {
  return minus.get();
});
calculator.a = 11;
calculator.b = 12; // 캐시된 값ㅇ 불러온다

console.log(minus.value);
console.log(minus.value);
calculator.a = 20; // 값이 변경되면 다시 계산한다.

console.log(minus.value);
},{"mobx":"node_modules/mobx/lib/mobx.module.js"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/valilla-mobx.e31bb0bc.js.map